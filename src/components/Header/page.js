...
export default function Header() {
  return (
    <div className="header ">
      ...
      <Image src={headerArrow} className="headerArrow" height={48} width={51} />
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="147"
        height="267"
      ...
      <nav className="absolute z-10 top-0 navBar">
        <div className="flex justify-center flex-row space-x-7 float-end p-7">
          ...
          <h3 className=" text-white navText pr-10 cursor-pointer">Services</h3>
          <h3 className="text-white navText pr-10 cursor-pointer">About us</h3>
